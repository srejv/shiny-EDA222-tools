...
joint.shapes.devs.Model = joint.shapes.basic.Generic.extend(_.extend({}, joint.shapes.basic.PortsModelInterface, {
    ...
    markup: '<g class="rotatable"><g class="scalable"><rect/></g><text class="label"/><g class="inPorts"/><g class="outPorts"/><g class="variablePorts"/></g>',
    ...
    getPortAttrs: function(portName, index, total, selector, type) {
        ...
        else if(selector === '.variablePorts') {
...
joint.shapes.devs.ModelB = joint.shapes.basic.Generic.extend(_.extend({}, joint.shapes.basic.PortsModelInterface, {
